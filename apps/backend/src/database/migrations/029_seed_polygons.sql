...
VALUES ('Circunvalación', 10),
  ...
  ('Área Capital', 110),
  ('Avenidas Urbanas', 120) ON CONFLICT (name) DO NOTHING;
-- =====================================================
...
VALUES -- Circunvalación
  ...
  (
    ...
    '{"lat":-31.3057,"lon":-64.4714}',
    true
  ),
  (
    'P018',
    'Vte. Anisacate RP 5-2',
    'Ruta Provincial 5',
    ...
    '{"lat":-31.4146,"lon":-64.4495}',
    true
  ),
  (
    'P019',
    'Vte Anisacate RP 5-1',
    'Ruta Provincial 5',
...
WHERE "group" IS NOT NULL
  AND TRIM("group") != '' ON CONFLICT (name) DO NOTHING;
