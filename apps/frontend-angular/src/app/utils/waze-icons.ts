 ...
 * Portado desde: apps/frontend/src/utils/wazeIcons.ts
 */

// Iconos SVG inline basados en los iconos oficiales de Waze
...
/**
 * Carga un icono Waze en el mapa MapLibre
 */
export function loadWazeIconToMap(map: maplibregl.Map, iconId: string): void {
