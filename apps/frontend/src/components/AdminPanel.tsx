...
import SSOConfiguration from './admin/SSOConfiguration';
...
const AdminPanel: React.FC = () => {
  ...
  const renderActiveSection = () => {
    switch (activeSection) {
      ...
      case 'reports':
        return <div className="p-8 text-center text-gray-500">Reportes - Próximamente</div>;
      default:
        return <PolygonManagement />;
    }
  };
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-9">
            <motion.div
              ...
              className="bg-white rounded-xl shadow-lg min-h-[600px]"
            >
              {renderActiveSection()}
            </motion.div>
          </div>
