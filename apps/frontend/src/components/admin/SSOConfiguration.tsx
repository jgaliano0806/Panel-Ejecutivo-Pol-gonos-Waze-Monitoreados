    ...
    setProviders(prev => prev.map(provider =>
      provider.id === providerId
        ? {
            ...
            isConfigured: isProviderConfigured({ ...provider.config, [field]: value })
          }
        : provider
    ));
  };
    ...
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Configura el inicio de sesión único con Microsoft Azure AD y Google OAuth 2.0
        </p>
      </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-blue-800">
              Para configurar SSO necesitarás registrar tu aplicación en los portales de desarrolladores
              de Microsoft y Google. Asegúrate de configurar correctamente las URLs de redireccionamiento.
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="p-6 space-y-4">
                ...
                <>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => updateProviderConfig(provider.id, 'tenantId', e.target.value)}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      >
                        {showSecrets[provider.id] ? <EyeOff size={16} /> : <Eye size={16} />}
                      </button>
                    </div>
                  </div>
                </>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  />
                  <button
                    onClick={() => navigator.clipboard.writeText(provider.config.redirectUri || '')}
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Copia esta URL y configúrala en el portal de desarrolladores de {provider.name}
                </p>
              </div>
              ...
              <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                  ...
                  {provider.lastTested && (
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-gray-600">
                        Última prueba: {new Date(provider.lastTested).toLocaleString('es-AR')}
                      </span>
                    </div>
                  )}
                </div>
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    disabled={!provider.isConfigured || testingProvider === provider.id}
      ...
      <div className="mt-8 space-y-6">
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          ...
          <div className="space-y-4">
            <div>
              <h4 className="font-medium text-gray-900 mb-2">Microsoft Azure AD:</h4>
              <ol className="list-decimal list-inside text-sm text-gray-600 space-y-1">
                <li>Ve al <a href="https://portal.azure.com" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">Azure Portal</a></li>
                <li>Registra una nueva aplicación en "Azure Active Directory" → "App registrations"</li>
                <li>Copia el "Application (client) ID" y "Directory (tenant) ID"</li>
            ...
            <div>
              ...
              <ol className="list-decimal list-inside text-sm text-gray-600 space-y-1">
                <li>Ve a la <a href="https://console.cloud.google.com" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">Google Cloud Console</a></li>
