...
export const CongestionIndexCard: React.FC<CongestionIndexCardProps> = ({
  ...
  const getColor = () => {
    if (metrics.congestionIndex <= 30)
      return "text-green-600 bg-green-50 border-green-300";
    if (metrics.congestionIndex <= 60)
  ...
  const totalPoints =
    metrics.slowPoints +
    metrics.moderatePoints +
    metrics.fastPoints +
    metrics.stoppedPoints;
    ...
    <div className="card">
      ...
      <div className="flex items-center gap-6 mb-4">
        ...
        <div className="flex-shrink-0">
          <div
            className={`w-28 h-28 rounded-full border-4 ${getColor()} flex items-center justify-center`}
          >
          ...
          <div>
            ...
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div
                ...
                style={{
                  width: `${(metrics.stoppedPoints / totalPoints) * 100}%`,
                }}
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div
                ...
                style={{
                  width: `${(metrics.slowPoints / totalPoints) * 100}%`,
                }}
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div
                ...
                style={{
                  width: `${(metrics.moderatePoints / totalPoints) * 100}%`,
                }}
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div
                ...
                style={{
                  width: `${(metrics.fastPoints / totalPoints) * 100}%`,
                }}
              />
            </div>
          </div>
