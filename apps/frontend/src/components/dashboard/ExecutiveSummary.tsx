    ...
    <div className="card">
        ...
        {metrics.map((metric, index) => {
          ...
          return (
            <div
              key={metric.label}
              onClick={() =>
                isClickable && hasEvents && setShowEventsModal(true)
              }
              ...
              title={
                isClickable && hasEvents
                  ? "Click para ver detalle de eventos"
                  : ""
              }
            >
      ...
      <div className="mt-4 pt-4 border-t border-gray-200 grid grid-cols-3 gap-4 text-center">
        <div>
          ...
          >
            {kpis.trends?.fluidityChange !== undefined &&
        ...
        <div>
          ...
          >
            {kpis.trends?.incidentsChange !== undefined &&
            kpis.trends.incidentsChange > 0
              ? "▲"
              : "▼"}{" "}
