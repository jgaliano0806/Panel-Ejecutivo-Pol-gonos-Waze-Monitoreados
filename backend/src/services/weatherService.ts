...
export class WeatherService {
  ...
  private async fetchAccuWeather(
    ...
    try {
      ...
      // Si está lloviendo pero no hay precipitación acumulada, usar valor mínimo
      const effectivePrecipitation =
        isRaining && precipitation === 0 && pastHourPrecipitation === 0
          ? 0.1 // Valor mínimo para indicar que está lloviendo
          : precipitation > 0
          ? precipitation
          : pastHourPrecipitation;
