...
# Copiar todo el proyecto a C:\PanelWaze en el servidor

# Opción B: Desde la máquina local, usar robocopy via red
robocopy "C:\Users\usuario\Desktop\Proyectos CASISA\Panel-Waze-Monitoreados" "\\10.1.0.136\C$\PanelWaze" /MIR /XD node_modules dist .git 192.168.49.33 /XF "*.log"
```
...
- Backend stdout: `C:\PanelWaze\logs\backend-stdout.log`
- Backend stderr: `C:\PanelWaze\logs\backend-stderr.log`
...
Get-Content C:\PanelWaze\logs\backend-stderr.log -Tail 30
```
...
2. Verificar que el build exista: `Test-Path C:\PanelWaze\apps\frontend\dist\index.html`
3. Si no existe, reconstruir: `cd C:\PanelWaze\apps\frontend; npm run build`
