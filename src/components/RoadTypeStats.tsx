        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-gray-200">
              ...
              <th className="text-center py-2 px-3 font-semibold text-gray-700">Atascos</th>
              <th className="text-center py-2 px-3 font-semibold text-gray-700">Vel. Prom.</th>
              <th className="text-center py-2 px-3 font-semibold text-gray-700">Demora Prom.</th>
              <th className="text-center py-2 px-3 font-semibold text-gray-700">Long. Total</th>
            </tr>
          </thead>
          <tbody>
            {stats.map((stat) => (
              <tr key={stat.roadType} className="border-b border-gray-100 hover:bg-gray-50">
